...
export default function CreateInvoice() {
    const { clients, currencies, defaultCurrency } = usePage().props as any;
    ...
    return (        <AppLayout breadcrumbs={[{ title: 'Invoices', href: '/invoices' }, { title: 'Create', href: '/invoices/create' }]}>
            ...
            <div className="w-full mx-auto p-4">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 bg-white dark:bg-neutral-900 p-4 rounded shadow">{/* Remove the old logo section */}
                    <div>
                    ...
                    <div className="flex gap-2 justify-end">
                        <button type="submit" className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">Create Invoice</button>
                    </div>
                </form>
            </div>
        </AppLayout>
